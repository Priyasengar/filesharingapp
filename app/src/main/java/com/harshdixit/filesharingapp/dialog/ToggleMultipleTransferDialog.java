package com.harshdixit.filesharingapp.dialog;
...
import com.harshdixit.filesharingapp.view.TextDrawable;
...
public class ToggleMultipleTransferDialog extends AlertDialog.Builder
{
    ...
    private class ActiveListAdapter extends BaseAdapter
    {
        ...
        {
            if (convertView == null)
                convertView = mInflater.inflate(R.layout.dialog_toggle_transfer, parent,
                        false);
