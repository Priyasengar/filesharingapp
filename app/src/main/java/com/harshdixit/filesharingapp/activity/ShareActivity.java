...
import com.harshdixit.filesharingapp.util.OrganizeShareRunningTask;
        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "genonbeta.intent.action.TBShare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "genonbeta.intent.action.TBShare_SEND_MULTIPLE";
