package com.harshdixit.filesharingapp.adapter;
...
import com.harshdixit.filesharingapp.base.GlideApp;
...
import com.harshdixit.filesharingapp.util.MimeIconUtils;
import com.harshdixit.filesharingapp.R;
import com.harshdixit.filesharingapp.model.FileShortcutObject;
import com.harshdixit.filesharingapp.model.TransferGroup;
import com.harshdixit.filesharingapp.model.TransferObject;
import com.harshdixit.filesharingapp.model.WritablePathObject;
        ...
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<FileListAdapter.GenericFileHolder>
{
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister)
    {
        ...
        if (path != null) {
            ...
            lister.offerObliged(this, new DirectoryHolder(defaultFolder, getContext().getString(R.string.text_receivedFiles), R.mipmap.ic_launcher));
    ...
    public GroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        if (viewType == VIEW_TYPE_ACTION_BUTTON)
            return new GroupViewHolder(getInflater().inflate(R.layout.view_button, parent, false), R.id.text);

        return new GroupViewHolder(getInflater().inflate(R.layout.row_file, parent, false));
    }
