...
import com.harshdixit.filesharingapp.dialog.FolderCreationDialog;
...
import com.harshdixit.filesharingapp.adapter.PathResolverRecyclerAdapter;
        ...
        implements Activity.OnBackPressedListener, DetachListener, IconSupport, TitleSupport
{
    ...
    {
        View adaptedView = getLayoutInflater().inflate(R.layout.fragment_file_explorer, null, false);
