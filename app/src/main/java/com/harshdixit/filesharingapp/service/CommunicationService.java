...
import com.harshdixit.filesharingapp.base.AppConfig;
import com.harshdixit.filesharingapp.base.Keyword;
import com.harshdixit.filesharingapp.db.AccessDatabase;
import com.harshdixit.filesharingapp.fragment.FileListFragment;
import com.harshdixit.filesharingapp.util.AppUtils;
import com.harshdixit.filesharingapp.util.CommunicationBridge;
import com.harshdixit.filesharingapp.util.CommunicationNotificationHelper;
import com.harshdixit.filesharingapp.util.DynamicNotification;
import com.harshdixit.filesharingapp.util.FileUtils;
import com.harshdixit.filesharingapp.util.HotspotUtils;
import com.harshdixit.filesharingapp.util.NetworkDeviceLoader;
import com.harshdixit.filesharingapp.util.NetworkUtils;
import com.harshdixit.filesharingapp.util.NotificationUtils;
import com.harshdixit.filesharingapp.util.NsdDiscovery;
import com.harshdixit.filesharingapp.util.TimeUtils;
import com.harshdixit.filesharingapp.util.TransferUtils;
import com.genonbeta.CoolSocket.CoolSocket;
import com.genonbeta.CoolSocket.CoolTransfer;
import com.harshdixit.filesharingapp.R;
import com.harshdixit.filesharingapp.model.NetworkDevice;
import com.harshdixit.filesharingapp.model.TextStreamObject;
import com.harshdixit.filesharingapp.model.TransferGroup;
import com.harshdixit.filesharingapp.model.TransferInstance;
import com.harshdixit.filesharingapp.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.abc.filesharingapp.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.abc.filesharingapp.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.abc.filesharingapp.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.abc.filesharingapp.action.IP";
    public static final String ACTION_END_SESSION = "com.abc.filesharingapp.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.abc.filesharingapp.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.abc.filesharingapp.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.abc.filesharingapp.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.abc.filesharingapp.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.abc.filesharingapp.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.abc.filesharingapp.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.abc.filesharingapp.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.abc.filesharingapp.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.abc.filesharingapp.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.abc.filesharingapp.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.abc.filesharingapp.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.abc.filesharingapp.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.abc.filesharingapp.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.abc.filesharingapp.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.abc.filesharingapp.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.abc.filesharingapp.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.abc.filesharingapp.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.abc.filesharingapp.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.abc.filesharingapp.transaction.action.REQUEST_WEBSHARE_STATUS";
    ...
    public void startFileReceiving(long groupId, String deviceId) throws Exception
    {
            ...
            try {
                ...
                if (responseJSON.has(Keyword.REQUEST)
                    ...
                    getSelfExecutor().submit(new Runnable()
                    {
                        ...
                        {
                            try {
                                AppConfig.sendUpdate(getApplicationContext(), activeConnection.getClientAddress());
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                        }
